...
const AuraBackground: FC<AuraBackgroundProps> = ({ pattern }) => {
  ...
  useEffect(() => {
    ...
    const baseHue3 = 60;  // warm amber-ish
      ...
      for (let y = 0; y < rows; y++) {
        for (let x = 0; x < cols; x++) {
          ...
          if (pattern === "flow") {
            ...
            // Radial breathing from center, more “heartbeat / mood”
            ...
            // Flickery, sparkly pattern that feels a bit like nervous energy
            const noise =
            ...
            hue = baseHue1 * (0.5 + 0.5 * noise) + baseHue2 * (0.5 - 0.5 * noise);
